...
#pragma region Aatrox
	...
	Spells.push_back(CreateSpell()->_ChampName("Aatrox")->_MenuName("AatroxE")->_SpellName("AatroxE")->_DangerValue(2)->_MissileName("AatroxEConeMissile")->_Slot(kSlotE)->_Range(1075)->_Radius(60)->_MissileSpeed(1250)->_FixedRange(true)->_CollisionObjects(kCollidesWithYasuoWall));
#pragma endregion

#pragma region Ahri
	Spells.push_back(CreateSpell()->_ChampName("Ahri")->_MenuName("AhriQ")->_SpellName("AhriOrbofDeception")->_DangerValue(2)->_MissileName("AhriOrbMissile")->_MissileSpeed(2500)->_Range(1000)->_Radius(100)->_FixedRange(true)->_MissileAccel(-3200)->_MissileMaxSpeed(2500)->_MissileMinSpeed(400)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Ahri")->_MenuName("AhriQReturn")->_SpellName("AhriOrbReturn")->_DangerValue(3)->_Delay(0)->_MissileName("AhriOrbReturn")->_Range(20000)->_Radius(100)->_MissileSpeed(60)->_MissileAccel(1900)->_MissileMaxSpeed(2600)->_MissileMinSpeed(60)->_MissileToUnit(true)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Ahri")->_MenuName("AhriE")->_SpellName("AhriSeduce")->_DangerValue(3)->_MissileName("AhriSeduceMissile")->_Slot(kSlotE)->_Range(1000)->_Radius(60)->_MissileSpeed(1550)->_FixedRange(true)->_IsDangerous(true)->_CollisionObjects(kCollidesWithMinions | kCollidesWithYasuoWall));
#pragma endregion
...
#pragma region Anivia
	Spells.push_back(CreateSpell()->_ChampName("Anivia")->_MenuName("AniviaQ")->_SpellName("FlashFrostSpell")->_DangerValue(3)->_MissileName("FlashFrostSpell")->_MissileSpeed(850)->_Range(1100)->_Radius(110)->_FixedRange(true)->_IsDangerous(true)->_CollisionObjects(kCollidesWithYasuoWall));
#pragma endregion
...
#pragma region Annie
	...
	Spells.push_back(CreateSpell()->_ChampName("Annie")->_DangerValue(5)->_MenuName("AnnieR")->_SpellName("InfernalGuardian")->_IsDangerous(true)->_Slot(kSlotR)->_Type(ST_Circle)->_Range(600)->_Radius(250)->_AddHitbox(true));
#pragma endregion
...
#pragma region Azir
	Spells.push_back(CreateSpell()->_ChampName("Azir")->_MenuName("AzirQ")->_SpellName("AzirQWrapper")->_DangerValue(2)->_Delay(0)->_MissileName("AzirSoldierMissile")->_Range(20000)->_Radius(70)->_MissileSpeed(1600)->_MissileOnly(true)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Azir")->_DangerValue(3)->_MenuName("AzirR")->_Slot(kSlotR)->_SpellName("AzirR")->_MissileSpeed(1400)->_Range(750)->_Radius(150)->_BehindStart(300)->_FixedRange(true)->_CollisionObjects(kCollidesWithYasuoWall));
#pragma endregion

#pragma region Bard
	Spells.push_back(CreateSpell()->_ChampName("Bard")->_MenuName("BardQ")->_MissileName("BardQMissile")->_SpellName("BardQ")->_DangerValue(3)->_MissileSpeed(1500)->_Range(950)->_Radius(60)->_FixedRange(true)->_IsDangerous(true)->_CollisionObjects(kCollidesWithYasuoWall));
...
#pragma region Braum
	...
	Spells.push_back(CreateSpell()->_ChampName("Braum")->_MenuName("BraumR")->_SpellName("BraumRWrapper")->_DangerValue(4)->_Delay(550)->_MissileName("BraumRMissile")->_Slot(kSlotR)->_Range(1200)->_MissileSpeed(1400)->_Radius(115)->_FixedRange(true)->_HasStartExplosion(true)->_IsDangerous(true)->_RadiusEx(330)->_CollisionObjects(kCollidesWithYasuoWall));
#pragma endregion

#pragma region Caitlyn
	Spells.push_back(CreateSpell()->_ChampName("Caitlyn")->_MenuName("CaitlynQ")->_SpellName("CaitlynPiltoverPeacemaker")->_DangerValue(2)->_Delay(625)->_MissileName("CaitlynPiltoverPeacemaker")->_Range(1300)->_Radius(60)->_MissileSpeed(2200)->_FixedRange(true)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Caitlyn")->_MenuName("CaitlynQBehind")->_SpellName("CaitlynQBehind")->_DangerValue(2)->_Delay(0)->_MissileName("CaitlynPiltoverPeacemaker2")->_Range(1300)->_Radius(90)->_MissileSpeed(2200)->_CollisionObjects(kCollidesWithYasuoWall));
...
#pragma region Camille
	Spells.push_back(CreateSpell()->_ChampName("Camille")->_MenuName("CamilleE")->_MissileName("CamilleEMissile")->_SpellName("CamilleE")->_DangerValue(2)->_MissileSpeed(2500)->_Range(1100)->_Delay(250)->_Slot(kSlotE)->_Radius(80)->_Type(ST_Line)->_FixedRange(true)->_CanBeRemoved(true)->_AddHitbox(true)->_IsDangerous(false)->_CollisionObjects(kCollidesWithHeroes));
	Spells.push_back(CreateSpell()->_ChampName("Camille")->_MenuName("CamilleEDash2")->_MissileName("CamilleEDash2")->_SpellName("CamilleEDash2")->_DangerValue(2)->_MissileSpeed(2500)->_Range(800)->_Delay(250)->_Slot(kSlotE)->_Radius(80)->_Type(ST_Line)->_FixedRange(true)->_AddHitbox(true)->_IsDangerous(false)->_CollisionObjects(kCollidesWithHeroes));
#pragma endregion
...
#pragma region Corki
	Spells.push_back(CreateSpell()->_ChampName("Corki")->_MenuName("CorkiQ")->_SpellName("PhosphorusBomb")->_MissileName("PhosphorusBombMissile")->_DangerValue(2)->_Delay(300)->_MissileSpeed(1000)->_Range(825)->_Radius(250)->_Type(ST_Circle)->_CollisionObjects(kCollidesWithYasuoWall)->_ExtraMissileNames("PhosphorusBombMissileMin"));
...
#pragma region Diana
	Spells.push_back(CreateSpell()->_ChampName("Diana")->_DangerValue(3)->_MenuName("DianaQCircle")->_SpellName("DianaArc")->_MissileSpeed(1400)->_Type(ST_Circle)->_Range(850)->_Radius(195)->_IsDangerous(true)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Diana")->_DangerValue(3)->_MenuName("DianaQArc")->_SpellName("DianaArc")->_Range(850)->_MissileSpeed(1400)->_Type(ST_Arc)->_Radius(70)->_DontCross(true)->_IsDangerous(true)->_TakeClosestPath(true)->_CollisionObjects(kCollidesWithYasuoWall));
...
#pragma region Draven
	Spells.push_back(CreateSpell()->_ChampName("Draven")->_MenuName("DravenE")->_SpellName("DravenDoubleShot")->_DangerValue(3)->_MissileName("DravenDoubleShotMissile")->_Slot(kSlotE)->_Range(1100)->_MissileSpeed(1400)->_Radius(130)->_FixedRange(true)->_IsDangerous(true)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Draven")->_MenuName("DravenR")->_SpellName("DravenRCast")->_DangerValue(5)->_MissileName("DravenR")->_Delay(525)->_MissileSpeed(2000)->_Slot(kSlotR)->_Range(25000)->_Radius(160)->_FixedRange(true)->_IsDangerous(true)->_InfrontStart(250)->_CollisionObjects(kCollidesWithYasuoWall)->_ExtraSpellNames("DravenRDoublecast"));
#pragma endregion

#pragma region Ekko
	Spells.push_back(CreateSpell()->_ChampName("Ekko")->_MenuName("EkkoQ")->_MissileName("EkkoQMis")->_SpellName("EkkoQ")->_DangerValue(4)->_MissileSpeed(1650)->_Range(950)->_Radius(60)->_FixedRange(true)->_IsDangerous(true)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Ekko")->_MenuName("EkkoQReturn")->_SpellName("EkkoQReturn")->_DangerValue(3)->_Delay(0)->_MissileName("EkkoQReturn")->_Range(20000)->_Radius(100)->_MissileSpeed(2300)->_MissileToUnit(true)->_CollisionObjects(kCollidesWithYasuoWall));
...
#pragma region Ezreal
	...
	Spells.push_back(CreateSpell()->_ChampName("Ezreal")->_MenuName("EzrealW")->_SpellName("EzrealEssenceFlux")->_DangerValue(2)->_MissileName("EzrealEssenceFluxMissile")->_Slot(kSlotW)->_Range(1050)->_MissileSpeed(1600)->_Radius(80)->_FixedRange(true)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Ezreal")->_MenuName("EzrealR")->_SpellName("EzrealTrueshotBarrage")->_DangerValue(3)->_MissileName("EzrealTrueshotBarrage")->_Slot(kSlotR)->_Range(25000)->_Delay(1000)->_MissileSpeed(2000)->_Radius(160)->_FixedRange(true)->_IsDangerous(true)->_CollisionObjects(kCollidesWithYasuoWall));
#pragma endregion
...
#pragma region Galio
	Spells.push_back(CreateSpell()->_ChampName("Galio")->_MenuName("GalioQ")->_SpellName("GalioResoluteSmite")->_DangerValue(2)->_MissileName("GalioResoluteSmite")->_Range(930)->_Radius(200)->_MissileSpeed(1300)->_Type(ST_Circle)->_CollisionObjects(kCollidesWithYasuoWall));
...
#pragma region Gnar
	Spells.push_back(CreateSpell()->_ChampName("Gnar")->_MenuName("GnarQ")->_MissileName("GnarQMissile")->_SpellName("GnarQMissile")->_DangerValue(2)->_MissileSpeed(2500)->_Range(1125)->_Radius(55)->_FixedRange(true)->_MissileAccel(-3000)->_MissileMaxSpeed(2500)->_MissileMinSpeed(1400)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Gnar")->_MenuName("GnarQReturn")->_SpellName("GnarQMissileReturn")->_DangerValue(2)->_Delay(0)->_MissileName("GnarQMissileReturn")->_Range(3000)->_Radius(75)->_FixedRange(true)->_MissileSpeed(60)->_Invert(true)->_MissileAccel(800)->_MissileMaxSpeed(2600)->_MissileMinSpeed(60)->_DisabledByDefault(true)->_CollisionObjects(kCollidesWithYasuoWall));
...
#pragma region Gragas
	Spells.push_back(CreateSpell()->_ChampName("Gragas")->_MenuName("GragasQ")->_MissileName("GragasQMissile")->_SpellName("GragasQ")->_DangerValue(2)->_ToggleName("Gragas_.+_Q_(Enemy|Ally)")->_Range(850)->_Radius(280)->_MissileSpeed(1000)->_DontCross(true)->_ExtraDuration(4300)->_Type(ST_Circle)->_CollisionObjects(kCollidesWithYasuoWall));
	...
	Spells.push_back(CreateSpell()->_ChampName("Gragas")->_MenuName("GragasR")->_MissileName("GragasRBoom")->_SpellName("GragasR")->_DangerValue(5)->_MissileSpeed(1800)->_Slot(kSlotR)->_Range(1050)->_Radius(350)->_Type(ST_Circle)->_IsDangerous(true)->_CollisionObjects(kCollidesWithYasuoWall));
#pragma endregion

#pragma region Graves
	Spells.push_back(CreateSpell()->_ChampName("Graves")->_MenuName("GravesQ")->_SpellName("GravesQLineSpell")->_DangerValue(2)->_MissileName("GravesQLineMis")->_MissileSpeed(3000)->_Range(808)->_Radius(40)->_FixedRange(true)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Graves")->_MenuName("GravesQReturn")->_SpellName("GravesQReturn")->_DangerValue(2)->_Delay(0)->_MissileName("GravesQReturn")->_Range(808)->_Radius(100)->_MissileSpeed(1600)->_FixedRange(true)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Graves")->_MenuName("GravesW")->_SpellName("GravesSmokeGrenade")->_MissileName("GravesSmokeGrenadeBoom")->_ToggleName("Graves_SmokeGrenade_.+_Team_(Green|Red)")->_MissileSpeed(1500)->_Slot(kSlotW)->_Range(950)->_Radius(225)->_Type(ST_Circle)->_ExtraDuration(4250)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Graves")->_MenuName("GravesR")->_SpellName("GravesChargeShot")->_DangerValue(5)->_MissileName("GravesChargeShotShot")->_Slot(kSlotR)->_Range(1000)->_MissileSpeed(2100)->_Radius(100)->_FixedRange(true)->_IsDangerous(true)->_CollisionObjects(kCollidesWithYasuoWall));
...
#pragma region Hecarim
	...
	Spells.push_back(CreateSpell()->_ChampName("Hecarim")->_MenuName("HecarimR")->_SpellName("HecarimRMissile")->_DangerValue(3)->_Delay(0)->_MissileName("HecarimUltMissile")->_Slot(kSlotR)->_Range(1500)->_MissileSpeed(1100)->_Radius(40)->_FixedRange(true)->_MissileOnly(true)->_CollisionObjects(kCollidesWithYasuoWall));
#pragma endregion

#pragma region Heimerdinger
	Spells.push_back(CreateSpell()->_ChampName("Heimerdinger")->_MenuName("HeimerdingerQTurretBlast")->_MissileName("HeimerdingerTurretEnergyBlast")->_SpellName("HeimerdingerQTurretBlast")->_DangerValue(2)->_Delay(0)->_MissileSpeed(1650)->_Range(1000)->_Radius(50)->_FixedRange(true)->_MissileAccel(-1000)->_MissileMaxSpeed(1650)->_MissileMinSpeed(1200)->_MissileOnly(true)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Heimerdinger")->_MenuName("HeimerdingerQTurretBigBlast")->_MissileName("HeimerdingerTurretBigEnergyBlast")->_SpellName("HeimerdingerQTurretBigBlast")->_DangerValue(2)->_Delay(0)->_MissileSpeed(1650)->_Range(1000)->_Radius(75)->_FixedRange(true)->_MissileAccel(-1000)->_MissileMaxSpeed(1650)->_MissileMinSpeed(1200)->_MissileOnly(true)->_CollisionObjects(kCollidesWithYasuoWall));
	...
	Spells.push_back(CreateSpell()->_ChampName("Heimerdinger")->_MenuName("HeimerdingerE")->_SpellName("HeimerdingerE")->_DangerValue(2)->_MissileName("HeimerdingerESpell")->_Slot(kSlotE)->_Range(950)->_Radius(100)->_MissileSpeed(1200)->_Type(ST_Circle)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Heimerdinger")->_MenuName("HeimerdingerEUlt")->_SpellName("HeimerdingerEUlt")->_DangerValue(2)->_MissileName("HeimerdingerESpell_ult")->_Slot(kSlotE)->_Range(1000)->_MissileSpeed(1200)->_Type(ST_Circle)->_Radius(150)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Heimerdinger")->_MenuName("HeimerdingerEUltBounce")->_MissileName("HeimerdingerESpell_ult2")->_SpellName("HeimerdingerEUltBounce")->_DangerValue(2)->_Slot(kSlotE)->_Delay(175)->_MissileSpeed(1400)->_Type(ST_Circle)->_Range(1000)->_Radius(150)->_DisabledByDefault(true)->_MissileDelayed(true)->_CollisionObjects(kCollidesWithYasuoWall)->_ExtraMissileNames("HeimerdingerESpell_ult3"));
#pragma endregion
...
#pragma region Irelia
	Spells.push_back(CreateSpell()->_ChampName("Irelia")->_MenuName("Irelia")->_SpellName("IreliaTranscendentBlades")->_DangerValue(2)->_MissileName("IreliaTranscendentBladesSpell")->_Slot(kSlotR)->_Range(1200)->_Delay(0)->_MissileSpeed(1600)->_Radius(120)->_FixedRange(true)->_MissileOnly(true)->_CollisionObjects(kCollidesWithYasuoWall));
#pragma endregion
...
#pragma region Janna
	Spells.push_back(CreateSpell()->_ChampName("Janna")->_MenuName("JannaQ")->_SpellName("HowlingGale")->_DangerValue(2)->_Delay(0)->_MissileName("HowlingGaleSpell")->_Range(20000)->_Radius(120)->_MissileSpeed(900)->_MissileOnly(true)->_CollisionObjects(kCollidesWithYasuoWall));
#pragma endregion
...
#pragma region Jinx
	...
	Spells.push_back(CreateSpell()->_ChampName("Jinx")->_MenuName("JinxR")->_MissileName("JinxR")->_SpellName("JinxR")->_DangerValue(5)->_Delay(600)->_MissileSpeed(1700)->_Slot(kSlotR)->_Range(25000)->_Radius(140)->_FixedRange(true)->_IsDangerous(true)->_CollisionObjects(kCollidesWithYasuoWall));
#pragma endregion
...
#pragma region KogMaw
	...
	Spells.push_back(CreateSpell()->_ChampName("KogMaw")->_MenuName("KogMawE")->_SpellName("KogMawVoidOozeMissile")->_DangerValue(2)->_MissileName("KogMawVoidOozeMissile")->_Slot(kSlotE)->_Range(1300)->_MissileSpeed(1400)->_Radius(120)->_FixedRange(true)->_CollisionObjects(kCollidesWithYasuoWall));
...
#pragma region Leona
	Spells.push_back(CreateSpell()->_ChampName("Leona")->_MenuName("LeonaE")->_SpellName("LeonaZenithBlade")->_DangerValue(3)->_MissileName("LeonaZenithBladeMissile")->_Slot(kSlotE)->_Range(900)->_MissileSpeed(2000)->_Radius(70)->_FixedRange(true)->_IsDangerous(true)->_TakeClosestPath(true)->_CollisionObjects(kCollidesWithYasuoWall));
...
#pragma region Lissandra
	Spells.push_back(CreateSpell()->_ChampName("Lissandra")->_MenuName("LissandraQ")->_SpellName("LissandraQMissile")->_DangerValue(2)->_MissileName("LissandraQMissile")->_MissileSpeed(2200)->_Range(700)->_Radius(75)->_FixedRange(true)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Lissandra")->_MenuName("LissandraQExplosion")->_SpellName("LissandraQShards")->_DangerValue(2)->_Delay(0)->_MissileName("LissandraQShards")->_Range(1650)->_Radius(90)->_MissileSpeed(2200)->_CollisionObjects(kCollidesWithYasuoWall));
	...
	Spells.push_back(CreateSpell()->_ChampName("Lissandra")->_MenuName("LissandraE")->_SpellName("LissandraEMissile")->_DangerValue(2)->_MissileName("LissandraEMissile")->_Slot(kSlotE)->_Range(1025)->_Radius(125)->_FixedRange(true)->_MissileSpeed(850)->_CollisionObjects(kCollidesWithYasuoWall));
#pragma endregion
...
#pragma region Lulu
	Spells.push_back(CreateSpell()->_ChampName("Lulu")->_MenuName("LuluQ")->_MissileName("LuluQMissile")->_SpellName("LuluQ")->_DangerValue(2)->_Range(950)->_Radius(60)->_MissileSpeed(1450)->_FixedRange(true)->_CollisionObjects(kCollidesWithYasuoWall)->_ExtraMissileNames("LuluQMissileTwo"));
#pragma endregion

#pragma region Lux
	Spells.push_back(CreateSpell()->_ChampName("Lux")->_MenuName("LuxQ")->_SpellName("LuxLightBinding")->_DangerValue(3)->_MissileName("LuxLightBindingMis")->_Range(1300)->_Radius(70)->_MissileSpeed(1200)->_FixedRange(true)->_IsDangerous(true)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Lux")->_MenuName("LuxE")->_SpellName("LuxLightStrikeKugel")->_DangerValue(2)->_MissileName("LuxLightStrikeKugel")->_ToggleName("Lux_.+_E_tar_aoe_(green|red)")->_MissileSpeed(1300)->_Slot(kSlotE)->_Type(ST_Circle)->_Range(1100)->_Radius(330)->_ExtraDuration(5100)->_DisabledByDefault(true)->_DontCross(true)->_CollisionObjects(kCollidesWithYasuoWall));
...
#pragma region Malphite
	Spells.push_back(CreateSpell()->_ChampName("Malphite")->_DangerValue(2)->_MenuName("MalphiteE")->_SpellName("Landslide")->_Delay(250)->_Slot(kSlotE)->_Type(ST_Circle)->_Radius(270));
...
#pragma region Malzahar
	Spells.push_back(CreateSpell()->_ChampName("Malzahar")->_MenuName("MalzaharQ")->_SpellName("MalzaharQ")->_DangerValue(2)->_Delay(0)->_MissileName("MalzaharQMissile")->_Range(750)->_Radius(85)->_FixedRange(true)->_MissileSpeed(1600));
#pragma endregion
...
#pragma region Nami
	Spells.push_back(CreateSpell()->_ChampName("Nami")->_MenuName("NamiQ")->_MissileName("NamiQMissile")->_SpellName("NamiQ")->_DangerValue(3)->_MissileSpeed(2500)->_Type(ST_Circle)->_Range(850)->_Radius(200)->_ExtraDelay(700)->_IsDangerous(true)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Nami")->_MenuName("NamiR")->_MissileName("NamiRMissile")->_SpellName("NamiRMissile")->_DangerValue(2)->_Delay(500)->_MissileSpeed(850)->_Slot(kSlotR)->_Range(2750)->_Radius(250)->_FixedRange(true)->_CollisionObjects(kCollidesWithYasuoWall));
#pragma endregion
...
#pragma region Nocturne
	Spells.push_back(CreateSpell()->_ChampName("Nocturne")->_MenuName("NocturneQ")->_SpellName("NocturneDuskbringer")->_DangerValue(2)->_MissileName("NocturneDuskbringer")->_Range(1200)->_Radius(60)->_MissileSpeed(1400)->_FixedRange(true)->_CollisionObjects(kCollidesWithYasuoWall));
#pragma endregion

#pragma region Olaf
	Spells.push_back(CreateSpell()->_ChampName("Olaf")->_MenuName("OlafQ")->_SpellName("OlafAxeThrowCast")->_DangerValue(2)->_MissileName("OlafAxeThrow")->_MissileSpeed(1600)->_Range(1000)->_Radius(90)->_ExtraRange(150)->_CollisionObjects(kCollidesWithYasuoWall));
#pragma endregion
...
#pragma region Poppy
	...
	Spells.push_back(CreateSpell()->_ChampName("Poppy")->_MenuName("PoppyRCharge")->_SpellName("PoppyRSpell")->_DangerValue(3)->_Delay(350)->_MissileName("PoppyRMissile")->_Slot(kSlotR)->_Range(1200)->_MissileSpeed(1600)->_Radius(100)->_IsDangerous(true)->_CollisionObjects(kCollidesWithYasuoWall));
#pragma endregion
...
#pragma region Ryze
	Spells.push_back(CreateSpell()->_ChampName("Ryze")->_MenuName("RyzeQ")->_MissileName("RyzeQ")->_SpellName("RyzeQ")->_Delay(350)->_DangerValue(2)->_MissileSpeed(1700)->_Range(1000)->_Radius(80)->_FixedRange(true)->_CollisionObjects(kCollidesWithMinions | kCollidesWithHeroes | kCollidesWithYasuoWall));
#pragma endregion
...
#pragma region Shyvana
	Spells.push_back(CreateSpell()->_ChampName("Shyvana")->_MenuName("ShyvanaE")->_SpellName("ShyvanaFireball")->_DangerValue(2)->_MissileName("ShyvanaFireballMissile")->_Slot(kSlotE)->_Range(950)->_MissileSpeed(1575)->_Radius(60)->_FixedRange(true)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Shyvana")->_MenuName("ShyvanaEDragon")->_SpellName("ShyvanaFireballDragon2")->_MissileName("ShyvanaFireballDragonMissile")->_DangerValue(3)->_Delay(350)->_MissileSpeed(1575)->_Slot(kSlotE)->_Range(780)->_Radius(60)->_HasEndExplosion(true)->_InfrontStart(200)->_RadiusEx(350)->_CollisionObjects(kCollidesWithYasuoWall)->_ExtraMissileNames("ShyvanaFireballDragonMissileBig")->_ExtraMissileNames("ShyvanaFireballDragonMissileMax"));
...
#pragma region Sivir
	Spells.push_back(CreateSpell()->_ChampName("Sivir")->_MenuName("SivirQ")->_MissileName("SivirQMissile")->_SpellName("SivirQ")->_DangerValue(2)->_MissileSpeed(1350)->_Range(1250)->_Radius(90)->_FixedRange(true)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Sivir")->_MenuName("SivirQReturn")->_SpellName("SivirQReturn")->_DangerValue(2)->_Delay(0)->_MissileName("SivirQMissileReturn")->_Range(20000)->_Radius(100)->_MissileSpeed(1350)->_MissileToUnit(true)->_CollisionObjects(kCollidesWithYasuoWall));
#pragma endregion

#pragma region Skarner
	Spells.push_back(CreateSpell()->_ChampName("Skarner")->_MenuName("SkarnerE")->_SpellName("SkarnerFracture")->_DangerValue(2)->_MissileName("SkarnerFractureMissile")->_Slot(kSlotE)->_Range(1000)->_MissileSpeed(1500)->_Radius(70)->_FixedRange(true)->_CollisionObjects(kCollidesWithYasuoWall));
#pragma endregion

#pragma region Sona
	Spells.push_back(CreateSpell()->_ChampName("Sona")->_MenuName("SonaR")->_MissileName("SonaR")->_SpellName("SonaR")->_DangerValue(5)->_MissileSpeed(2400)->_Slot(kSlotR)->_Range(1000)->_Radius(140)->_FixedRange(true)->_IsDangerous(true)->_CollisionObjects(kCollidesWithYasuoWall));
#pragma endregion

#pragma region Soraka
	Spells.push_back(CreateSpell()->_ChampName("Soraka")->_MenuName("SorakaQ")->_MissileName("SorakaQMissile")->_SpellName("SorakaQ")->_DangerValue(2)->_MissileSpeed(1100)->_Type(ST_Circle)->_Range(800)->_Radius(230));
...
#pragma region Syndra
	...
	Spells.push_back(CreateSpell()->_ChampName("Syndra")->_DangerValue(2)->_MenuName("SyndraE")->_SpellName("SyndraE")->_MissileSpeed(2000)->_Slot(kSlotE)->_Range(950)->_Radius(100)->_Type(ST_MissileCone)->_DontCross(true)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Syndra")->_DangerValue(2)->_MenuName("SyndraEMax")->_SpellName("SyndraE5")->_MissileSpeed(2000)->_Slot(kSlotE)->_Range(950)->_Radius(100)->_Type(ST_MissileCone)->_DontCross(true)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Syndra")->_DangerValue(2)->_MenuName("SyndraEQ")->_SpellName("SyndraEQ")->_Delay(0)->_MissileSpeed(2000)->_Slot(kSlotE)->_Range(1300)->_Radius(55)->_DontCheckForDuplicates(true)->_CollisionObjects(kCollidesWithYasuoWall));
#pragma endregion
...
#pragma region Talon
	Spells.push_back(CreateSpell()->_ChampName("Talon")->_MenuName("TalonW")->_MissileName("TalonWMissileOne")->_SpellName("TalonW")->_DangerValue(2)->_MissileSpeed(2500)->_Slot(kSlotW)->_Range(850)->_Radius(75)->_FixedRange(true)->_IsDangerous(true)->_MultipleAngle(M_PI)->_MultipleNumber(3)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Talon")->_MenuName("TalonWReturn")->_SpellName("TalonWReturn")->_DangerValue(2)->_Delay(0)->_MissileName("TalonWMissileTwo")->_Slot(kSlotW)->_Range(20000)->_MissileSpeed(3000)->_Radius(75)->_IsDangerous(true)->_MissileToUnit(true)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Talon")->_MenuName("TalonR")->_MissileName("TalonRMisOne")->_SpellName("TalonR")->_DangerValue(2)->_Delay(0)->_MissileSpeed(2400)->_Slot(kSlotR)->_Range(550)->_Radius(140)->_FixedRange(true)->_IsDangerous(true)->_MissileOnly(true)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Talon")->_MenuName("TalonRReturn")->_SpellName("TalonRReturn")->_DangerValue(2)->_Delay(0)->_MissileName("TalonRMisTwo")->_Slot(kSlotR)->_Range(20000)->_MissileSpeed(4000)->_Radius(140)->_IsDangerous(true)->_MissileToUnit(true)->_CollisionObjects(kCollidesWithYasuoWall));
#pragma endregion
...
#pragma region Thresh
	...
	Spells.push_back(CreateSpell()->_ChampName("Thresh")->_MenuName("ThreshE")->_MissileName("ThreshEMissile1")->_SpellName("ThreshE")->_DangerValue(3)->_Delay(0)->_MissileSpeed(2000)->_Slot(kSlotE)->_Range(1075)->_Radius(110)->_FixedRange(true)->_IsDangerous(true)->_MissileOnly(true)->_CollisionObjects(kCollidesWithYasuoWall));
#pragma endregion
...
#pragma region	Fate
	Spells.push_back(CreateSpell()->_ChampName("TwistedFate")->_MenuName("TwistedFateQ")->_SpellName("WildCards")->_DangerValue(2)->_MissileName("SealFateMissile")->_MissileSpeed(1000)->_Range(1450)->_Radius(40)->_FixedRange(true)->_MultipleNumber(3)->_MultipleAngle(M_PI)->_CollisionObjects(kCollidesWithYasuoWall));
#pragma endregion

#pragma region Twitch
	Spells.push_back(CreateSpell()->_ChampName("Twitch")->_MenuName("TwitchW")->_SpellName("TwitchVenomCask")->_MissileName("TwitchVenomCaskMissile")->_ToggleName("twitch_w_indicator_(green|red)_team")->_DangerValue(2)->_MissileSpeed(1400)->_Slot(kSlotW)->_Range(950)->_Radius(285)->_Type(ST_Circle)->_ExtraDuration(2850)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Twitch")->_MenuName("TwitchR")->_SpellName("TwitchSprayAndPrayAttack")->_DangerValue(2)->_MissileName("TwitchSprayAndPrayAttack")->_Slot(kSlotR)->_Range(1100)->_Delay(0)->_MissileSpeed(4000)->_Radius(60)->_FixedRange(true)->_MissileOnly(true)->_CollisionObjects(kCollidesWithYasuoWall));
#pragma endregion
...
#pragma region Urgot
	...
	Spells.push_back(CreateSpell()->_ChampName("Urgot")->_MenuName("UrgotE")->_SpellName("UrgotPlasmaGrenade")->_DangerValue(2)->_MissileName("UrgotPlasmaGrenadeBoom")->_Slot(kSlotE)->_Range(900)->_MissileSpeed(1500)->_Type(ST_Circle)->_Radius(250)->_CollisionObjects(kCollidesWithYasuoWall));
#pragma endregion

#pragma region Varus
	Spells.push_back(CreateSpell()->_ChampName("Varus")->_MenuName("VarusQ")->_MissileName("VarusQMissile")->_SpellName("VarusQ")->_DangerValue(2)->_Type(ST_Line)->_Delay(250)->_Slot(kSlotQ)->_MissileSpeed(1850)->_Range(1625)->_Radius(70)->_AddHitbox(true)->_FixedRange(true)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Varus")->_MenuName("VarusE")->_MissileName("VarusEMissile")->_SpellName("VarusE")->_DangerValue(2)->_MissileSpeed(1500)->_Slot(kSlotE)->_Range(925)->_Radius(260)->_Type(ST_Circle)->_ExtraDelay(550)->_CollisionObjects(kCollidesWithYasuoWall));
...
#pragma region Veigar
	Spells.push_back(CreateSpell()->_ChampName("Veigar")->_MenuName("VeigarQ")->_SpellName("VeigarBalefulStrike")->_DangerValue(2)->_MissileName("VeigarBalefulStrikeMis")->_Range(950)->_Radius(70)->_MissileSpeed(2200)->_FixedRange(true)->_CollisionObjects(kCollidesWithYasuoWall));
	...
	Spells.push_back(CreateSpell()->_ChampName("Veigar")->_DangerValue(3)->_MenuName("VeigarE")->_SpellName("VeigarEventHorizon")->_Delay(800)->_RadiusEx(300)->_Slot(kSlotE)->_Type(ST_Ring)->_Range(700)->_Radius(390)->_DontAddExtraDuration(true)->_DontCross(true)->_ExtraDuration(3000)->_IsDangerous(true)->_AddHitbox(false));
#pragma endregion
...
#pragma region Velkoz
	...
	Spells.push_back(CreateSpell()->_ChampName("Velkoz")->_MenuName("VelkozW")->_MissileName("VelkozWMissile")->_SpellName("VelkozW")->_DangerValue(2)->_MissileSpeed(1700)->_Slot(kSlotW)->_Range(1200)->_Radius(88)->_BehindStart(100)->_FixedRange(true)->_CollisionObjects(kCollidesWithYasuoWall));
...
#pragma region Viktor
	...
	Spells.push_back(CreateSpell()->_ChampName("Viktor")->_MenuName("ViktorE")->_SpellName("ViktorDeathRay")->_MissileName("ViktorDeathRayMissile")->_DangerValue(2)->_Delay(0)->_MissileSpeed(1050)->_Slot(kSlotE)->_Range(710)->_Radius(80)->_FixedRange(true)->_MissileOnly(true)->_CollisionObjects(kCollidesWithYasuoWall)->_ExtraMissileNames("ViktorEAugMissile"));
	Spells.push_back(CreateSpell()->_ChampName("Viktor")->_MenuName("ViktorEExplosion")->_SpellName("ViktorDeathRay(xxx)")->_MissileName("ViktorDeathRayMissile2")->_DangerValue(2)->_Delay(1000)->_MissileSpeed(1500)->_Slot(kSlotE)->_Range(710)->_Radius(80)->_FixedRange(true)->_CollisionObjects(kCollidesWithYasuoWall));
#pragma endregion
...
#pragma region Yasuo
	...
	Spells.push_back(CreateSpell()->_ChampName("Yasuo")->_MenuName("YasuoQ3")->_MissileName("YasuoQ3Mis")->_SpellName("YasuoQ3")->_DangerValue(3)->_Delay(300)->_MissileSpeed(1200)->_Range(1100)->_Radius(90)->_FixedRange(true)->_Invert(true)->_IsDangerous(true)->_CollisionObjects(kCollidesWithYasuoWall));
#pragma endregion
...
#pragma region Zed
	Spells.push_back(CreateSpell()->_ChampName("Zed")->_MenuName("ZedQ")->_MissileName("ZedQMissile")->_SpellName("ZedQ")->_DangerValue(2)->_MissileSpeed(1700)->_Range(925)->_Radius(50)->_FixedRange(true)->_CollisionObjects(kCollidesWithYasuoWall));
...
#pragma region Ziggs
	Spells.push_back(CreateSpell()->_ChampName("Ziggs")->_MenuName("ZiggsQ")->_MissileName("ZiggsQSpell")->_SpellName("ZiggsQ")->_DangerValue(2)->_MissileSpeed(1700)->_Range(850)->_Radius(125)->_Type(ST_Circle)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Ziggs")->_MenuName("ZiggsQBounce")->_SpellName("ZiggsQBounce")->_DangerValue(2)->_MissileName("ZiggsQSpell2")->_Delay(400)->_MissileSpeed(1600)->_Range(1100)->_Radius(125)->_Type(ST_Circle)->_MissileDelayed(true)->_CollisionObjects(kCollidesWithYasuoWall)->_ExtraMissileNames("ZiggsQSpell3"));
	Spells.push_back(CreateSpell()->_ChampName("Ziggs")->_MenuName("ZiggsW")->_MissileName("ZiggsW")->_SpellName("ZiggsW")->_DangerValue(2)->_MissileSpeed(1750)->_Slot(kSlotW)->_Range(1000)->_Radius(275)->_Type(ST_Circle)->_CollisionObjects(kCollidesWithYasuoWall));
	Spells.push_back(CreateSpell()->_ChampName("Ziggs")->_MenuName("ZiggsE")->_MissileName("ZiggsE2")->_SpellName("ZiggsE")->_DangerValue(2)->_MissileSpeed(1550)->_Slot(kSlotE)->_Range(900)->_Radius(235)->_Type(ST_Circle)->_CollisionObjects(kCollidesWithYasuoWall));
...
#pragma region Zilean
	Spells.push_back(CreateSpell()->_ChampName("Zilean")->_MenuName("ZileanQ")->_MissileName("ZileanQMissile")->_SpellName("ZileanQ")->_DangerValue(2)->_ToggleName("Zilean_.+_Q_TimeBombGround(Green|Red)")->_Range(900)->_Radius(150)->_Delay(250)->_MissileSpeed(2000)->_Type(ST_Circle)->_ExtraDuration(3100)->_DontCross(true)->_ExtraDelay(450)->_CollisionObjects(kCollidesWithYasuoWall));
#pragma endregion

#pragma region Zyra
	Spells.push_back(CreateSpell()->_ChampName("Zyra")->_DangerValue(2)->_MenuName("ZyraQ")->_SpellName("ZyraQ")->_Range(800)->_Delay(850)->_Perpendicular(true)->_RadiusEx(800)->_Type(ST_Box)->_Radius(100));
	Spells.push_back(CreateSpell()->_ChampName("Zyra")->_MenuName("ZyraE")->_MissileName("ZyraE")->_SpellName("ZyraE")->_DangerValue(3)->_MissileSpeed(1150)->_Slot(kSlotE)->_Range(1150)->_Radius(70)->_FixedRange(true)->_IsDangerous(true)->_CollisionObjects(kCollidesWithYasuoWall));
